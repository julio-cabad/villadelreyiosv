...
const CreateAccount = (props) => {
    ...
    const [resetCords, setResetCord] = useState(false);
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <KeyboardAwareScrollView contentContainerStyle={styles.bodyContainer} scrollEnabled
                                     ...
                                     enableResetScrollToCoords={resetCords}
                ...
                >
                    {({
                        ...
                        if ((values.password === values.checkPassword) && control &&
                            (values.password !== '' && values.checkPassword !== '')) {
                            Keyboard.dismiss();
                            setResetCord(true);
                            setControl(false)
                            setTimeout(() => setResetCord(false), 50);
                        }
                        ...
                        return (
                            <>
                                ...
                                <View style={{
                                    ...
                                    {/*<RegisterButtons text={'Usuario y contraseña'} icon={'user-alt'}
                                         onPress={handleEmailPwd}/>
                                    <RegisterButtons text={'Huella dactilar'} icon={'fingerprint'}
                                         onPress={handleEmailPwd}/>*/}
                                </View>
                            </>
                        );
